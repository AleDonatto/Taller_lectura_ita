...
<main class="col s9 hide" id="main">
    <div class="container">
        ...
        <blockquote><h4>Selecciona un taller y completa tus datos</h4></blockquote>
                ...
                @foreach($taller as $item)
                    <div class="card-panel">
                        ...
                        <p><label for="taller">
                            ...
                            class="@error('taller') is-invalid @enderror">
        ...
        @elseif(session('registro')=='si')
        <form action="{{ route('sinscripcion') }}" class="col s12" method="POST">
            @csrf 
            <div class="row">
                @foreach($taller as $item)
                    <div class="card-panel">
                        ...
                        <p class="grey-text text-darken-3">Numero de Alumnos: {{ $item->NAlumnos }}</p>
                        <label>
                            <input name="taller" type="radio" value="{{ $item-> idTaller}}" >
